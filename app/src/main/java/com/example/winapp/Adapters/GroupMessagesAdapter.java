...
import com.example.winapp.databinding.ItemReceiveBinding;
import com.example.winapp.databinding.ItemReceiveGroupBinding;
import com.example.winapp.databinding.ItemSentBinding;
import com.example.winapp.databinding.ItemSentGroupBinding;
...
// explanation: for one actvity we need to create on view holder while we have two actvity send and recive so we need to create two view holder
//here we only extend it with adapter no need of view holder in two activity
